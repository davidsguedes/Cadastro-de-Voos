 ...
 * @author Guedes
 */
public class CancelarVooAction implements Action{
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            Logger.getLogger(CancelarVooAction.class.getName()).log(Level.SEVERE, null, ex);
