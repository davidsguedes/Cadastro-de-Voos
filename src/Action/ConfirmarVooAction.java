 ...
 * @author Guedes
 */
public class ConfirmarVooAction implements Action{
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) {
        ...
        String resultado = voo.confirmar();
        ...
        try {
            ...
            Logger.getLogger(ConfirmarVooAction.class.getName()).log(Level.SEVERE, null, ex);
